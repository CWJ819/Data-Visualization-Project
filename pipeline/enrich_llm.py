...
【创作阶段】这是河流图使用的粗略时间桶，不代表作品确切创作年份。必须输出 1-12 的整数序号，不要输出字符串、区间、阶段名称或具体年份。

阶段序号：
1=0713-0742 盛唐前期；2=0743-0754 盛唐后期；3=0755-0770 安史转折；4=0771-0805 中唐前期；5=0806-0835 中唐后期；6=0836-0907 晚唐；7=0908-0960 五代；8=0960-1042 北宋前期；9=1043-1093 北宋中期；10=1094-1126 北宋晚期；11=1127-1161 靖康南渡；12=1162-1279 南宋中后期。

阶段选择规则：
1. 不得选择与输入"时期"明显冲突的阶段。
2. 若断裂标签含"安史之乱"，优先选 3；若含"靖康之变"，优先选 11。
3. 若只知道粗时期但难以细分，按时期选择保守默认：盛唐→2，中唐→4，晚唐→6，五代→7，北宋→9，南宋→12。
4. "创作阶段"字段必须是 JSON 数字，例如 "创作阶段": 3；不要写成 "3"、"0755-0770"、"南宋时期" 或 "未定年"。
"""
